...
namespace Bucket.Utility
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return Helpers.Converts.ToBool(obj);
        }
        ...
        {
            return Helpers.Converts.ToBoolOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToInt(obj);
        }
        ...
        {
            return Helpers.Converts.ToIntOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToLong(obj);
        }
        ...
        {
            return Helpers.Converts.ToLongOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToDouble(obj);
        }
        ...
        {
            return Helpers.Converts.ToDoubleOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToDecimal(obj);
        }
        ...
        {
            return Helpers.Converts.ToDecimalOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToDate(obj);
        }
        ...
        {
            return Helpers.Converts.ToDateOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToGuid(obj);
        }
        ...
        {
            return Helpers.Converts.ToGuidOrNull(obj);
        }
        ...
        {
            return Helpers.Converts.ToGuidList(obj);
        }
