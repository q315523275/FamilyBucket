...
namespace Bucket.Authorize
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// <param name="configuration"></param>
        /// <returns></returns>
        public static IServiceCollection UseAuthoriser(this AuthenticationBuilder authenticationBuilder, IServiceCollection services, Action<AuthoriserBuilder> action)
        {
            var service = services.First(x => x.ServiceType == typeof(IConfiguration));
            var configuration = (IConfiguration)service.ImplementationInstance;
            var builder = new AuthoriserBuilder(services, configuration);
            action(builder);
            return services;
        }
        /// <summary>
